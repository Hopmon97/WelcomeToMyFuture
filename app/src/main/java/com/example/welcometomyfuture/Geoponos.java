...
public class Geoponos extends AppCompatActivity {
    ...
    public void updateData(View view)
    {
        ...
        UpdateUser update = new UpdateUser(Geoponos.this);
        update.execute();
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (result.equals("success")) {
                    Intent intent = new Intent(Geoponos.this, Geoponos.class);
                    startActivity(intent);
                    finish();
                }
                else{
                    Toast.makeText(Geoponos.this, "Failed to update data", Toast.LENGTH_LONG).show();
                }
            } catch (Exception ex) {
                ex.printStackTrace();
            }
...
//lol gt o writer itan se comments
    ...
    {
        Intent intent = new Intent (Geoponos.this,ForgotPassword.class);
        startActivity(intent);
        finish();
    }
}
